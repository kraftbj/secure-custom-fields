...
if (! class_exists('ACF')) {
	...
	class ACF
	{
		...
		public function initialize()
		{
			...
			// Define settings.
			$this->settings = array(
				'name'                    => __('Secure Custom Fields', 'acf'),
...
if (! function_exists('scf_plugin_deactivated_notice')) {
	...
	function scf_plugin_deactivated_notice()
	{
		...
		$message = __("Secure Custom Fields and Advanced Custom Fields should not be active at the same time. We've automatically deactivated Advanced Custom Fields.", 'acf');
		if (2 === $deactivated_notice_id) {
			$message = __("Secure Custom Fields and Advanced Custom Fields PRO should not be active at the same time. We've automatically deactivated Advanced Custom Fields PRO.", 'acf');
		} elseif (3 === $deactivated_notice_id) {
			$message = __("This version of Secure Custom Fields cannot work with the legacy version of Secure Custom Fields. We've automatically deactivated your previous version of Secure Custom Fields.", 'acf');
		}
