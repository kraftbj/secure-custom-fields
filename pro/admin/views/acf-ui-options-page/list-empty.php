...
<div class="acf-no-options-pages-wrapper">
	<div class="acf-no-options-pages-inner">
		...
		<p><?php echo acf_esc_html( __( 'SCF options pages are custom admin pages for managing global settings via fields. You can create multiple pages and sub-pages.', 'acf' ) ); ?></p>
